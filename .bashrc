...
if [ $(echo $OS | grep -e 'Windows') ]; then
    ...
    if [[ $VIMRUNTIME != "" ]] ; then
        export PS1='\n\[\033[38;5;213m\]\D{%Y/%m/%d %H:%M:%S} \[\033[36m\]\u@\h\[\033[00m\] \[\033[1;32m\](vim)\[\033[00m\] \[\033[35m\]\w\[\033[31m\]$(__git_ps1)\[\033[00m\]\n\[\033[33m\]\$\[\033[00m\] '
    else
        export PS1='\n\[\033[38;5;213m\]\D{%Y/%m/%d %H:%M:%S} \[\033[36m\]\u@\h\[\033[00m\] \[\033[35m\]\w\[\033[31m\]$(__git_ps1)\[\033[00m\]\n\[\033[33m\]\$\[\033[00m\] '
    fi
fi
